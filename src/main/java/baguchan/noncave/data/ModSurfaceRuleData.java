...
public class ModSurfaceRuleData {
    ...
    private static final SurfaceRules.RuleSource MIDSHALE = makeStateRule(ModBlocks.MIDSHALE.get());
    ...
    public static SurfaceRules.RuleSource overworldLike(boolean p_198381_, boolean p_198382_, boolean p_198383_) {
        ...
        SurfaceRules.RuleSource surfacerules$rulesource20 = SurfaceRules.ifTrue(SurfaceRules.verticalGradient("noncave:midshale", VerticalAnchor.absolute(8), VerticalAnchor.absolute(25)), MIDSHALE);
